...
MOV DH, BH                  ; to reserve the input value in BH, first move that value to DH
ADD DH, CH                  ; adds the digits stored in the two registers and stores them in DH
SUB DH, 30h                 ; the result is in ASCII Hexa needs to be shown in decimal

MOV AH, 2                   ; 2 is used for single output
MOV DL, DH                  ; displays the input value
INT 21H 
...
ADD BH, 30h                 ; the result is in ASCII Hexa needs to be shown in decimal
